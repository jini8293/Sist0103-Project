...
class OuterObject {
	...
	static class InnerObject2 {
		...
		public void write2() {
			// System.out.println("외부 인스턴스 변수 a=" + a); 외부에 일반변수 접근 안됨
			System.out.println("외부 정적변수 b=" + b);
...
public class InnerClass_07 {
	...
	public static void main(String[] args) {
		OuterObject.InnerObject out = new OuterObject().new InnerObject();
		out.write();
		
		OuterObject.InnerObject2 out2 = new OuterObject.InnerObject2();
		out2.write2();
	}
