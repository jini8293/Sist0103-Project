...
//객체의 속성 : 인스턴스 변수			객체의 동작: 클래스의 메서드로 표현
//Object: 객체, 실제로 존재하는 사물(핸드폰, 자동차....)
//class: 객체를 정의해둔것, 객체를 생성하기 위해 존재(설계도...)
//Instance: 클래스에서 만들어진 객체를 그 클래스의 인스턴스라고 말함
...
public class ObjectReview_01 {
	...
	//p1.name="홍길동"; private인스턴스변수는 생성을 해도 변수에 전급안됨
	p1.setName("김민지");
	p1.setAddr("감남구");
	p1.setAge(22);
	...
	Person p2 = new Person("김소미",22,"서울시","010-3333-4444");
