...
class MyTest {
	...
	// 3번의 멤버변수를 한꺼번에 초기화하는 메서드
	public void setMemebrs(String name, String addr, int age) {
...
public class ObTest_07 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n**3개의 값을 한번에 변경하고 출력하기**");
		MyTest t2= new MyTest();
		t2.setMemebrs("이효리", "제주시", 22);
		System.out.println(t2.getMemebers());
	}
