		...
		<table class="table table-bordered" style="width: 400px">
			...
			<tr>
				...
				<td><input type="password" name="pass" placeholder="비밀번호"
					required="required" class="form-control" style="width: 150px"></td>
			</tr>
			<tr>
				<th width="100" class="table-info">운전면허</th>
				<td><input type="checkbox" name="chk">&nbsp;운전면허</td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit"
					class="btn btn-info" value="전송" style="width: 100px">
					<input type="reset" class="btn btn-warning" value="초기화" style="width: 100px"> </td>
			</tr>
